...
Now supports both email and name inputs
"""
...
# ============================================
app = FastAPI(title="AI Therapy Chatbot API", version="2.1.0")
...
def create_new_session(request: NewSessionRequest):
    ...
    Now accepts both email and name
    """
...
async def startup_event():
    ...
    print("=" * 50)
    print("🚀 Starting AI Therapy Chatbot API")
    print("=" * 50)
    test_connection()
    print("=" * 50)
